...
# Import list of uses :
uses_data <- read.csv(here::here("3_Ethnobotany", "processed_data", "uses_detail_count.csv"))
...
total_results$Destimate <- c(
  D_result_harv$DEstimate,
