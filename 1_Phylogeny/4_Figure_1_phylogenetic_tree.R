...
cladeda <- data.frame(
  nodeid = c(214, 205, 237, 244, 262, 289, 307, 316, 353, 349, 358),
...
plot_tree <- ggtree(tree_data,
  ...
  theme(
    legend.text = element_text(size = 45), legend.title = element_text(size = 50, face = "bold"),
    legend.position = c(0.88, 0.44)
  ) +

  annotate(geom = "text", x = 118, y = 0.25, label = "Number of WHP species (log10)", size = 18, fontface = 2) +
  annotate(
    geom = "segment", x = 68, xend = 80, y = 0.25, yend = 0.25, linewidth = 1,
    colour = "grey20"
  )
