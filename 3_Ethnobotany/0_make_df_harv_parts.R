...
harvested_parts_sep_cast <- dcast(harvested_parts_sep,
  formula =
    CD_REF_v17 + NOM_VALIDE ~ Partie_cueillie
) # converts presence of text to 1 and absence to 0


names(harvested_parts_sep_cast) <- c(
  "CD_REF", "NOM_VALIDE", "buds", "bark", # transalate
